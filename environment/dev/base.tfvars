...
##---------------------------------------------------------#
org                  = "job4u"  # Organization Name. Used to tag resources
tenant               = "api"    # AWS Account Name or unique ID for Tenant
environment          = "dev"    # Environment area eg., preprod or prod
# zone               = "dev"    # Environment with in one sub_tenant or business unit
terraform_version  = "Terraform v0.15.0"

##---------------------------------------------------------#
## VPC and Private-Subnets details for EKS Cluster
##---------------------------------------------------------#
...
# on_demand_instance_type   = ["m6g.xlarge"]
